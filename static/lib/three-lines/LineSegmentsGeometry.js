...
class LineSegmentsGeometry extends InstancedBufferGeometry {
	...
	setPositions( array ) {
		...
		this.lastNumPositions = Math.max(lineSegments.length, this.lastNumPositions);
	...
	setColors( array ) {
		...
		this.setAttribute( 'instanceColorStart', new InterleavedBufferAttribute( instanceColorBuffer, 4, 0 ) ); // rgba
		this.setAttribute( 'instanceColorEnd', new InterleavedBufferAttribute( instanceColorBuffer, 4, 4 ) ); // rgba
